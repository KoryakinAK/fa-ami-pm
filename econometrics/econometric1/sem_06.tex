...
\eqno(5)
\end{equation*}
Обратим внимание, что первый столбец матрицы $\displaystyle X$, состоит из 1 тогда и только тогда, когда есть сводный член $\displaystyle a_{0}$. Вспоминая действия с матрицами мы проверим, что элементы компактной записи (5), модели (4), идентичны системе (2).

...
\textbf{Задача 2}. Вычислить издержки по правилу (6) и сравнить с точным ответом.
...
\framebox[1.1\width]{Д/з} Вычислить предельное значение эндогенных переменных $m$ и $n$ по экозогенной переменной $M$ и дать трактовку $m$ и $n$. Пусть транзакционные издержки возрастают на 2\% во сколько в ответ в относительной мере (\%) увеличится велечина $m$.
